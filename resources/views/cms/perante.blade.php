    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
          ...
          <a style="text-align: center  " href="../../index3.html" class="brand-link">
            <span style="font-size:25px ; width: fit-content;" class="brand-text   font-weight-light">Dashboard</span>
          </a>
          ...
          <div class="sidebar">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
              ...
              <div class="info">
                ...
                <img class="brand-image img-circle elevation-3" src="{{ asset('storage/images/admin/' . auth('admin')->user()->images) }}"alt="User Image" width="100px" height="100px">
                @else
            ...
            <nav class="mt-2">
              <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <h6 style="color: white">  Country&City</h6>
                ...
                <li class="nav-item">
                  ...
                  <ul class="nav nav-treeview">
                    <li class="nav-item">
                      <i class="fa-regular fa-block-quote"></i>
                ...
                <li class="nav-item">
                  ...
                  <ul class="nav nav-treeview">
                    <li class="nav-item">
                      <i class="fa-regular fa-block-quote"></i>
                      <a href="{{ route('compnies.index') }}" class="nav-link">
                        <i class="fas fa-list-ul nav-icon"></i>
                        <p>index</p>
                      </a>
                      <a href="{{ route('compnies.create') }}" class="nav-link">
                ...
                <li class="nav-item">
                  ...
                  <ul class="nav nav-treeview">
                    <li class="nav-item">
                      <i class="fa-regular fa-block-quote"></i>
                      <a href="{{ route('compnybranchs.index') }}" class="nav-link">
                        <i class="fas fa-list-ul nav-icon"></i>
                        <p>index</p>
                      </a>
                      <a href="{{ route('compnybranchs.create') }}" class="nav-link">
                ...
                <h6 style="color: white">  Recycle</h6>
                <li class="nav-item">
                    <a href="{{ route('delate.index') }}" class="nav-link">
                        <i class="fas fa-list-ul nav-icon"></i>
                ...
                <h6 style="color: white">  Setting</h6>
